...
def banner():
    ...
    print(bcolors.RED + '''
________  .____     ____  ___  _____     ___________  __________ ________      _____ _______________________________ 
\_____  \ |    |    \   \/  / /     \    \_   _____/  \______   \\_____  \    /     \\______   \_   _____/\______   \
 /   |   \|    |     \     / /  \ /  \    |    __)_    |    |  _/ /   |   \  /  \ /  \|    |  _/|    __)_  |       _/
/    |    \    |___  /     \/    Y    \   |        \   |    |   \/    |    \/    Y    \    |   \|        \ |    |   \
\_______  /_______ \/___/\  \____|__  /  /_______  /   |______  /\_______  /\____|__  /______  /_______  / |____|_  /
        \/        \/      \_/       \/           \/           \/         \/         \/       \/        \/         \/ 
''')
...
class Email_Bomber:
    ...
    def __init__(self):
        try:
            ...
            self.mode = int(input(bcolors.RED + 'Enter BOMB mode (1,2,3,4) || 1:(1000) 2:(500) 3:(250) 4:(custom) <: '))
